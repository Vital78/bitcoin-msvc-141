...
// @@protoc_insertion_point(message_clear_start:payments.Output)
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    script_.UnsafeMutablePointer()->clear();
  }
  amount_ = GOOGLE_ULONGLONG(0);
  _has_bits_.Clear();
...
::google::protobuf::uint8* PaymentACK::InternalSerializeWithCachedSizesToArray(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, *payment_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::payments::Output* Arena::Create< ::payments::Output >(Arena* arena) {
  return Arena::CreateInternal< ::payments::Output >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::payments::PaymentDetails* Arena::Create< ::payments::PaymentDetails >(Arena* arena) {
  return Arena::CreateInternal< ::payments::PaymentDetails >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::payments::PaymentRequest* Arena::Create< ::payments::PaymentRequest >(Arena* arena) {
  return Arena::CreateInternal< ::payments::PaymentRequest >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::payments::X509Certificates* Arena::Create< ::payments::X509Certificates >(Arena* arena) {
  return Arena::CreateInternal< ::payments::X509Certificates >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::payments::Payment* Arena::Create< ::payments::Payment >(Arena* arena) {
  return Arena::CreateInternal< ::payments::Payment >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::payments::PaymentACK* Arena::Create< ::payments::PaymentACK >(Arena* arena) {
